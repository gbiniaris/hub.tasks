...
import {
  ...
  ScrollText, BookOpen, LayoutDashboard, TrendingUp, Briefcase } from
'lucide-react';
  ...
  return (
    <aside className={cn(
      ...
      <div className="h-14 flex items-center px-4 border-b border-sidebar-border shrink-0">
        {!collapsed &&
        <span className="font-bold text-sidebar-primary text-base tracking-tight truncate">Hub.Tasks</span>
        }
        <button
          onClick={onCollapse}
